...
from ctranslate2.specs import common_spec as common_spec, model_spec as model_spec
...
class MultiHeadAttentionSpec(model_spec.LayerSpec):
    ...
    def __init__(self, self_attention: bool = ..., relative_position: bool = ..., relative_attention_bias: bool = ..., rms_norm: bool = ..., rotary_dim: Incomplete | None = ..., rotary_interleave: bool = ..., rotary_scaling_type: Incomplete | None = ..., rotary_scaling_factor: int = ..., rotary_base: int = ..., num_heads_kv: Incomplete | None = ...) -> None: ...
