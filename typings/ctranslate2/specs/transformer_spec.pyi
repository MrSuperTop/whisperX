...
class TransformerEncoderSpec(model_spec.LayerSpec):
    ...
    def __init__(
        ...
        pre_norm: bool = ...,
        no_final_norm: bool = ...,
        activation: common_spec.Activation = ...,
        num_source_embeddings: int = ...,
        embeddings_merge: common_spec.EmbeddingsMerge = ...,
...
class TransformerDecoderSpec(model_spec.LayerSpec):
    ...
    def __init__(
        ...
        rms_norm: bool = ...,
        alibi: bool = ...,
        alibi_use_positive_positions: bool = ...,
        scale_alibi: bool = ...,
        rotary_dim: Optional[int] = ...,
        rotary_interleave: bool = ...,
        rotary_scaling_type: Optional[attention_spec.RotaryScalingType] = ...,
        rotary_scaling_factor: float = ...,
        rotary_base: float = ...,
        parallel_residual: bool = ...,
        shared_layer_norm: bool = ...,
        multi_query_attention: bool = ...,
        num_heads_kv: Optional[int] = ...,
    ) -> None: ...
...
class TransformerEncoderModelSpec(model_spec.LanguageModelSpec):
    ...
    def __init__(
        ...
        pooling_layer: bool = ...,
        pooling_activation: common_spec.Activation = ...,
    ) -> None: ...
    @property
    def name(self): ...
    @property
