...
class Audio:
    ...
    mono: Incomplete
    def __init__(self, sample_rate: Incomplete | None = ..., mono: Incomplete | None = ...) -> None: ...
    ...
    def crop(self, file: AudioFile, segment: Segment, duration: Optional[float] = ..., mode: str = ...) -> Tuple[Tensor, int]: ...
