...
class VoiceActivityDetection(SegmentationTaskMixin, Task):
    ...
    def __init__(self, protocol: Protocol, duration: float = ..., warm_up: Union[float, Tuple[float, float]] = ..., balance: Sequence[Text] = ..., weight: Text = ..., batch_size: int = ..., num_workers: int = ..., pin_memory: bool = ..., augmentation: BaseWaveformTransform = ..., metric: Union[Metric, Sequence[Metric], Dict[str, Metric]] = ...) -> None: ...
