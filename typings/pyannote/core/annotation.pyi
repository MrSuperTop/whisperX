...
class Annotation:
    @classmethod
    def from_df(cls, df: pd.DataFrame, uri: Optional[str] = ..., modality: Optional[str] = ...) -> Annotation: ...
    modality: Incomplete
    def __init__(self, uri: Optional[str] = ..., modality: Optional[str] = ...) -> None: ...
    @property
    def uri(self): ...
    ...
    def itertracks(self, yield_label: bool = ...) -> Iterator[Union[Tuple[Segment, TrackName], Tuple[Segment, TrackName, Label]]]: ...
    ...
    def new_track(self, segment: Segment, candidate: Optional[TrackName] = ..., prefix: Optional[str] = ...) -> TrackName: ...
    def __delitem__(self, key: Key): ...
    def __getitem__(self, key: Key) -> Label: ...
    def __setitem__(self, key: Key, label: Label): ...
    def empty(self) -> Annotation: ...
    def labels(self) -> List[Label]: ...
    def get_labels(self, segment: Segment, unique: bool = ...) -> Union[Set[Label], List[Label]]: ...
    ...
    def rename_labels(self, mapping: Optional[Dict] = ..., generator: LabelGenerator = ..., copy: bool = ...) -> Annotation: ...
    def relabel_tracks(self, generator: LabelGenerator = ...) -> Annotation: ...
    def support(self, collar: float = ...) -> Annotation: ...
    def co_iter(self, other: Annotation) -> Iterator[Tuple[Tuple[Segment, TrackName], Tuple[Segment, TrackName]]]: ...
    def __mul__(self, other: Annotation) -> np.ndarray: ...
    def discretize(self, support: Optional[Segment] = ..., resolution: Union[float, SlidingWindow] = ..., labels: Optional[List[Hashable]] = ..., duration: Optional[float] = ...): ...
    @classmethod
    def from_records(cls, records: Iterator[Tuple[Segment, TrackName, Label]], uri: Optional[str] = ..., modality: Optional[str] = ...) -> Annotation: ...
