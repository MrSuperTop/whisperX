...
class SlidingWindow:
    def __init__(self, duration: float = ..., step: float = ..., start: float = ..., end: Incomplete | None = ...) -> None: ...
    @property
    ...
    def crop(self, focus: Union[Segment, 'Timeline'], mode: Alignment = ..., fixed: Optional[float] = ..., return_ranges: Optional[bool] = ...) -> Union[np.ndarray, List[List[int]]]: ...
    ...
    def __call__(self, support: Union[Segment, 'Timeline'], align_last: bool = ...) -> Iterable[Segment]: ...
