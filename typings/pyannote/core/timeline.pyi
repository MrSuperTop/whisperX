...
class Timeline:
    ...
    uri: Incomplete
    def __init__(
        self, segments: Optional[Iterable[Segment]] = ..., uri: str = ...
    ) -> None: ...
    ...
    def crop_iter(
        self, support: Support, mode: CropMode = ..., returns_mapping: bool = ...
    ...
    def copy(
        self, segment_func: Optional[Callable[[Segment], Segment]] = ...
    ) -> Timeline: ...
    ...
    def to_annotation(
        self,
        generator: Union[str, Iterable[Label], None, None] = ...,
