...
class Pipeline:
    ...
    def parameters(self, trial: Optional[Trial] = ..., frozen: Optional[bool] = ..., instantiated: Optional[bool] = ...) -> dict: ...
    def initialize(self) -> None: ...
    def freeze(self, params: dict) -> Pipeline: ...
    def instantiate(self, params: dict[Any, Any]) -> Pipeline: ...
    @property
    def instantiated(self): ...
    def dump_params(self, params_yml: Path, params: Optional[dict] = ..., loss: Optional[float] = ...) -> str: ...
